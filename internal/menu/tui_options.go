...
func defaultMainItems() []mainMenuItem {
	return []mainMenuItem{
		...
		{id: "3", zh: "极简版", en: "Minimal Suite", descZh: "系统信息+CPU+内存+磁盘+测速节点×5，不含解锁/网络/路由测试。", descEn: "System info + CPU + memory + disk + 5 speed nodes. No unlock/network/routing tests.", needNet: false},
		{id: "4", zh: "精简版", en: "Standard Suite", descZh: "系统信息+CPU+内存+磁盘+跨国平台解锁+三网回程路由+TCP握手+测速节点×5。", descEn: "System info + CPU + memory + disk + streaming unlock + routing + TCP handshake + 5 speed nodes.", needNet: false},
		{id: "5", zh: "精简网络版", en: "Network Suite", descZh: "系统信息+CPU+内存+磁盘+上游及三网回程路由+TCP握手+测速节点×5。", descEn: "System info + CPU + memory + disk + backtrace routing + TCP handshake + 5 speed nodes.", needNet: false},
		{id: "6", zh: "精简解锁版", en: "Unlock Suite", descZh: "系统信息+CPU+内存+磁盘IO+跨国平台解锁+测速节点×5。", descEn: "System info + CPU + memory + disk IO + streaming unlock + 5 speed nodes.", needNet: false},
		{id: "7", zh: "网络单项", en: "Network Only", descZh: "仅网络维度：IP质量、回程、NT3、延迟、TCP握手、TGDC、网站和测速。", descEn: "Network-only profile: IP quality, route, latency, TCP handshake, TGDC, websites and speed.", needNet: true},
		{id: "8", zh: "解锁单项", en: "Unlock Only", descZh: "仅进行跨国平台解锁与流媒体可用性检测。", descEn: "Unlock-only profile for cross-border media/service availability.", needNet: true},
		{id: "9", zh: "硬件单项", en: "Hardware Only", descZh: "系统信息、CPU、内存、dd/fio 磁盘测试。", descEn: "Hardware-only profile with system, CPU, memory and disk tests.", needNet: false},
		{id: "10", zh: "IP质量检测", en: "IP Quality", descZh: "15个数据库IP质量检测+邮件端口连通性检测。", descEn: "IP quality check across 15 databases + email port connectivity test.", needNet: true},
